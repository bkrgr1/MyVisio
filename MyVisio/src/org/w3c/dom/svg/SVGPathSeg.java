...
import de.bkroeger.myvisio.svg.elements.SVGPathElementImpl;
import de.bkroeger.myvisio.svg.elements.SVGShapeElementImpl;
...
public interface SVGPathSeg {
    ...
    // Erweiterungen
	java.awt.geom.Path2D.Float paint(java.awt.geom.Path2D.Float path2d, 
			SVGBasicShapeElement shape, Graphics2D g2d, SVGPathSeg prevSeg);
	float getX();
	float getY();
	void setX(float x);
	void setY(float y);
